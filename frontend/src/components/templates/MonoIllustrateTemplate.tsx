              ...
              {portfolio.links && portfolio.links.length > 0 ? (
                portfolio.links.map(link => (
                  <a
                    ...
                    title={link.label}
                  >
                    <SocialIcon url={link.url} label={link.label} className="w-5 h-5" />
                  </a>
                ))
              ) : (
                <>
                  <a
                    ...
                    aria-label="GitHub"
                  >
                    <SocialIcon url="https://github.com" label="GitHub" className="w-5 h-5" />
                  </a>
                  <a
                    ...
                    aria-label="LinkedIn"
                  >
                    <SocialIcon url="https://linkedin.com" label="LinkedIn" className="w-5 h-5" />
                  </a>
                  <a
                  ...
                  >
                    <SocialIcon url="https://twitter.com" label="Twitter" className="w-5 h-5" />
                  </a>
                  <a
                    ...
                    aria-label="Email"
                  >
                    <SocialIcon url="mailto:hello@example.com" label="Email" className="w-5 h-5" />
                  </a>
                </>
              )}
            </div>
