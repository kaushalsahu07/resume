                  ...
                  {portfolio.links && portfolio.links.length > 0 ? (
                    ...
                    <>
                      <a
                        ...
                        aria-label="GitHub"
                      >
                        <SocialIcon url="https://github.com" label="GitHub" className="w-4 h-4" />
                      </a>
                      <a
                        ...
                        aria-label="LinkedIn"
                      >
                        <SocialIcon url="https://linkedin.com" label="LinkedIn" className="w-4 h-4" />
                      </a>
                    </>
                  )}
                </div>
            ...
            {portfolio.links && portfolio.links.length > 0 ? (
              portfolio.links.map((link) => (
                <a
                  ...
                  title={link.label}
                >
                  <SocialIcon url={link.url} label={link.label} className="w-4 h-4 sm:w-5 sm:h-5" />
                </a>
              ))
            ) : (
              <>
                <a
                  ...
                  aria-label="GitHub"
                >
                  <SocialIcon url="https://github.com" label="GitHub" className="w-4 h-4 sm:w-5 sm:h-5" />
                </a>
                <a
                  href="https://linkedin.com"
                  target="_blank"
                  ...
                  aria-label="LinkedIn"
                >
                  <SocialIcon url="https://linkedin.com" label="LinkedIn" className="w-4 h-4 sm:w-5 sm:h-5" />
                </a>
              </>
            )}
          </div>
